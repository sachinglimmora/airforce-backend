...
// ─── Courses ─────────────────────────────────────────────────────────────────
const courses = [
  { id: '1', title: 'Su-30MKI Engine Systems', category: 'Jet Engine Systems', description: 'Comprehensive training on AL-31FP turbofan engine systems, including startup procedures, monitoring, and troubleshooting.', moduleCount: 12, completedModules: 0, progress: 0, duration: '24 hours', difficulty: 'advanced', status: 'not-started', thumbnail: 'https://picsum.photos/400/250?random=1' },
  { id: '2', title: 'Hydraulic Systems Fundamentals', category: 'Hydraulics', description: 'Understanding aircraft hydraulic systems, components, maintenance procedures, and safety protocols.', moduleCount: 8, completedModules: 0, progress: 0, duration: '16 hours', difficulty: 'intermediate', status: 'not-started', thumbnail: 'https://picsum.photos/400/250?random=2' },
  { id: '3', title: 'Avionics Suite Overview', category: 'Avionics', description: 'Modern avionics systems including radar, navigation, communication, and electronic warfare suites.', moduleCount: 15, completedModules: 0, progress: 0, duration: '30 hours', difficulty: 'advanced', status: 'not-started', thumbnail: 'https://picsum.photos/400/250?random=3' },
  ...
  { id: '6', title: 'Electrical Systems', category: 'Electrical Systems', description: 'Aircraft electrical power generation, distribution, and emergency systems.', moduleCount: 9, completedModules: 0, progress: 0, duration: '18 hours', difficulty: 'intermediate', status: 'not-started', thumbnail: 'https://picsum.photos/400/250?random=6' },
  { id: '7', title: 'Landing Gear Systems', category: 'Landing Gear', description: 'Retraction/extension mechanisms, brakes, steering, and emergency extension.', moduleCount: 7, completedModules: 0, progress: 0, duration: '14 hours', difficulty: 'intermediate', status: 'not-started', thumbnail: 'https://picsum.photos/400/250?random=7' },
  { id: '8', title: 'Fuel Systems Management', category: 'Fuel Systems', description: 'Fuel storage, transfer, refueling procedures, and fuel system indications.', moduleCount: 6, completedModules: 0, progress: 0, duration: '12 hours', difficulty: 'beginner', status: 'not-started', thumbnail: 'https://picsum.photos/400/250?random=8' },
];
